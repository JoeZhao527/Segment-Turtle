...
cfg.DATASETS.VALID = ("turtle_parts_test",)
...
evaluator = COCOEvaluator("turtle_parts_test", output_dir="./output")
val_loader = build_detection_test_loader(cfg, "turtle_parts_test")
