...
def prepare_model(cfg):
    cfg.merge_from_file(model_zoo.get_config_file("Turtle-Semantic/deeplab-semantic.yaml"))
    ...
    cfg.SOLVER.MAX_ITER = 80   # 300 iterations seems good enough for this toy dataset; you will need to train longer for a practical dataset
    cfg.SOLVER.STEPS = []        # do not decay learning rate
    
    cfg.MODEL.DEVICE = 'cuda' if torch.cuda.is_available() else 'cpu'
    cfg.TEST.EVAL_PERIOD = 40
    cfg.OUTPUT_DIR = "./output_deeplab"
